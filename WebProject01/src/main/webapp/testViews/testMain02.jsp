...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  <a class="navbar-brand" href="#">카드 가맹점 찾기 서비스</a>
	</nav>
	...
	<div class="main-container">
		...
		<div class="sub-container">
			...
			<form class="form-inline my-2 my-lg-0" action="<%=TEST_REQ_ACTION_ENUM.REQ_TEST_KAKAO_MAP.getRequestURI() %>", method="post" style="padding-top:20px; padding-bottom:20px;">
		        <input autocomplete="off" class="form-control mr-sm-2" type="text" name="<%= Const.LOC_SEARCH_KEYWORD%>" placeholder="우리 동네 혹은 가맹점을 찾아보세요." style="width:800px; height:50px;">
			</form>
	        <button class="btn btn-primary" type="submit" style="width:400px; height:50px;">지금 내 위치를 찾아주세요.</button>
			<button class="btn btn-secondary my-2 my-sm-0" type="submit" style="width:400px; height:50px;">건너뛰기 ></button>							
		</div>
