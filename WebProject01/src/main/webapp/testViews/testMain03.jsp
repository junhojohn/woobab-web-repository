	...
	<section id="mainViewport" class="viewport">
		<header id="mainHeader" class="header body-header">
			...
			<section id="mainTitleSection" class="mainTitleSection">
				...
				<br>
				<form id="gotoMapForm" class="form-inline my-2 my-lg-0" action="<%=TEST_REQ_ACTION_ENUM.REQ_TEST_KAKAO_MAP.getRequestURI() %>", method="post">
		        	...
		        	<button id="buttonGotoMap" class="btn btn-secondary my-2 my-sm-0" type="submit" name="<%= Const.LOC_SEARCH_KEYWORD%>" value="">건너뛰기 ></button>
				</form>
			</section>		
		</header>
	</section>
